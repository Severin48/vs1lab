...
pgButton.addEventListener("click", function(){
    console.log("page");
    let pageNr = "?pageNr=" + (document.getElementById("pg_btn").getAttribute("value"));
    let alternativePgNr = document.getElementById("pg_btn").innerHTML;
    ajax.open("GET", "/geotags/pg"+pageNr, true);
    ajax.responseType = "json";
    alternativePgNr.replace('<a></a>', '');
